...
_letter_loop_start:  
    ...
    ;cmp rdi, 1 ; current letter == 1 (Start of Heading in ASCII) ?
    ;jne _pass_1 ; current letter != 1 (Start of Heading in ASCII)
    
    ;jmp _letter_loop_continue
                                         
    ;cmp r10, 2 ; current letter == 2 (Start of Text in ASCII) ?
    ;jne _pass_1 ; current letter != 2 (Start of Text in ASCII) 
    
    ;jmp _letter_loop_continue
    
    ;cmp r10, 3 ; current letter == 3 (End of Text in ASCII) ?
    ;jne _pass_1 ; current letter != 3 (End of Text in ASCII) 
    
    ;jmp _letter_loop_continue
        
    ;cmp r10, 4 ; current letter == 4 (End of Transmission in ASCII) ?
    ;jne _pass_1 ; current letter != 4 (End of Transmission in ASCII)      
...
;_word_length_if_1:
;    cmp r10, 1 ; current letter != 1 (Start of Heading in ASCII) ?
;    je _word_length_end ; current letter == 1 (Start of Heading in ASCII)
                  
;_word_length_if_2:                        
;    cmp r10, 2 ; current letter != 2 (Start of Text in ASCII) ?
;    je _word_length_end ; current letter == 2 (Start of Text in ASCII) 
