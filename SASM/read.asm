...
CMAIN:
    ...
    ;mov     rcx, 0777o          ; Create file from lesson 22
    ;mov     rbx, filename
    ;mov     rax, 8
    ;int     80h
    ...
    mov     rcx, 0              ; Open file from lesson 24
    mov     rbx, filename
    mov     rax, 5
    int     80h
 
    mov     rdx, 1000             ; number of bytes to read - one for each letter of the file contents
    mov     rcx, fileContents   ; move the memory address of our file contents variable into rcx
